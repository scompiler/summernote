...
describe('base:core.range', () => {
    describe('nodes', () => {
        describe('1 depth', () => {
            ...
            before(() => {
                const $cont = $('<div class="note-editable"><p>para1</p><p>para2</p></div>');
                $para = $cont.find('p');
            });
        ...
        describe('multi depth', () => {
            it('should return array of a paragraph', () => {
                const $cont = $('<div class="note-editable"><p>p<b>ar</b>a1</p><p>para2</p></div>');
                const $b = $cont.find('b');
        ...
        describe('on list, on heading', () => {
            it('should return array of list paragraphs', () => {
                const $cont = $('<div class="note-editable"><ul><li>para1</li><li>para2</li></ul></div>');
                const $li = $cont.find('li');
            ...
            it('should return array of list paragraphs', () => {
                const $cont = $('<div class="note-editable"><h1>heading1</h1><h2>heading2</h2></div>');
                const $h1 = $cont.find('h1');
                const $h2 = $cont.find('h2');
    ...
    describe('expand', () => {
        it('should return <b>|b</b> ~ <u>u|</u> for <b>|b</b> with isAnchor', () => {
            const $cont = $('<div><a><b>b</b><u>u</u></a></div>');
            const $anchor = $cont.find('a');
            const $b = $cont.find('b');
    ...
    describe('collapse', () => {
        it('should return <u>u|</u> for <b>|b</b> ~ <u>u|</u>', () => {
            const $cont = $('<div><b>b</b><u>u</u></div>');
            const $b = $cont.find('b');
            const $u = $cont.find('u');
    ...
    describe('normalize (block mode)', () => {
        it('should return <p>text</p><p>|<br></p> for <p>text</p><p>|<br></p>', () => {
            const $cont = $('<div><p>text</p><p><br></p></div>');
            const $p = $cont.find('p');
        ...
        it('should return <p>text</p><p>|text</p> for <p>text</p><p>|text</p>', () => {
            const $cont = $('<div><p>text</p><p>text</p></div>');
            const $p = $cont.find('p');
        ...
        it('should return <p>|text</p><p>text|</p> for |<p>text</p><p>text</p>|', () => {
            const $cont = $('<div class="note-editable"><p>text</p><p>text</p></div>');
            const $p = $cont.find('p');

            const rng = range.create($cont[0], 0, $cont[0], 2).normalize();
    ...
    describe('normalize (void element)', () => {
        it('should return <p><img>|<b>bold</b></p> for <p><img>|<b>bold</b></p>', () => {
            const $cont = $('<div><p><img><b>bold</b></p></div>');
            const $p = $cont.find('p');
            const $b = $cont.find('b');
        ...
        it('should return <p><img>|text></p> for <p><img>|text></p>', () => {
            const $cont = $('<div><p><img>bold</p></div>');
            const $img = $cont.find('img');
    ...
    describe('insertNode', () => {
        it('should split paragraph when inserting a block element', () => {
            const $cont = $('<div class="note-editable"><p><b>bold</b></p></div>');
            const $b = $cont.find('b');
            const $p2 = $('<p>p</p>');
    ...
    describe('wrapBodyInlineWithPara', () => {
        it('should insert an empty paragraph when there is no contents', () => {
            const $cont = $('<div class="note-editable"></div>');

            const rng = range.create($cont[0], 0);
        ...
        it('should wrap text with paragraph for text', () => {
            const $cont = $('<div class="note-editable">text</div>');

            const rng = range.create($cont[0].firstChild, 2);
            rng.wrapBodyInlineWithPara();
        ...
        it('should wrap an inline node with paragraph when selecting text in the inline node', () => {
            const $cont = $('<div class="note-editable"><b>bold</b></div>');
            const $b = $cont.find('b');
        ...
        it('should wrap inline nodes with paragraph when selecting text in the inline nodes', () => {
            const $cont = $('<div class="note-editable"><b>b</b><i>i</i></div>');
        ...
        it('should wrap inline nodes with paragraph when selection some of text in the inline nodes #1', () => {
            ...
            const rng = range.create($cont[0], 1);
            rng.wrapBodyInlineWithPara();
        ...
        it('should wrap inline nodes with paragraph when selection some of text in the inline nodes #2', () => {
            ...
            const rng = range.create($cont[0], 2);
            rng.wrapBodyInlineWithPara();
    ...
    describe('getWordRange', () => {
        ...
        it('should return the range itself when there is no word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 0).getWordRange();
        ...
        it('should return expanded range when there is a word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 5).getWordRange();
        ...
        it('should return expanded range when there is a half word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 3).getWordRange();
        ...
        it('should return expanded range when there are words before cursor', () => {
            const rng = range.create($cont[0].firstChild, 12).getWordRange();
    ...
    describe('getWordsRange', () => {
        ...
        it('should return the range itself when there is no word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 0).getWordsRange();
        ...
        it('should return expanded range when there is a word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 5).getWordsRange();
        ...
        it('should return expanded range when there is a half word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 3).getWordsRange();
        ...
        it('should return expanded range when there are words before cursor', () => {
            const rng = range.create($cont[0].firstChild, 14).getWordsRange();
    ...
    describe('getWordsMatchRange', () => {
        ...
        it('should return null when there is no word before cursor', () => {
            const rng = range.create($cont[0].firstChild, 0).getWordsMatchRange(regex);
            expect(rng).to.be.a('null');
        });

        it('should return expanded range when there are words before cursor', () => {
            const rng = range.create($cont[0].firstChild, 13).getWordsMatchRange(regex);
        ...
        it('should return null when can not match', () => {
            const rng = range.create($cont[0].firstChild, 14).getWordsMatchRange(regex);
